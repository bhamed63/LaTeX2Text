...
namespace LatexConverter.Data
{
    ...
    {
        internal static List<FontCharacter> FontLibrary { get; private set; } = new()
        {
            // mathbb
        ...
        internal static List<ScriptCharacter> ScriptLibrary { get; private set; } = new()
        {
        ...
        internal static Dictionary<string, SymbolDefinition> SymbolLibrary { get; private set; } = new()
        {
        ...
        internal static Dictionary<string, OperatorMapping> OperatorMap { get; private set; } = new()
        {
        ...
        internal static List<string> DeniedConvertWithoutSlash { get; private set; } = new() { CommandNames.Bullet, CommandNames.In, CommandNames.Times, CommandNames.Sum, CommandNames.Exists, CommandNames.To, CommandNames.Angle, CommandNames.Triangle, CommandNames.Natural, CommandNames.Sharp, CommandNames.Parallel, CommandNames.Prod, CommandNames.Flat, CommandNames.Lim };
    }
}
