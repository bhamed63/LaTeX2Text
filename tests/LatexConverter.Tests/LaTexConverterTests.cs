...
namespace LatexConverter.Tests
{
    public class LaTexConverterTests
    {
        ...
        //[InlineData("√(a²+b²) / 2", "the square root of a squared plus b squared divided by 2")]
        //[InlineData("∑ᵢ₌₁ⁿ i²", "summation from i equals 1 to n i squared")]
        //[InlineData("∫₀^(∞) e⁻ˣ dx", "integral from 0 to infinity e to the power of minus x dx")]
        ...
        //[InlineData("4.0 × 10⁻⁴", "4.0 times 10 to the power of minus 4")]
        ...
        //[InlineData("V(r) = (q / (4 * π * ε₀ * a₀)) * exp(-2 * r / a₀) * (1 + a₀/r).", "V(r) equals (q divided by (4 times pi times epsilon subscript 0 times a subscript 0)) times exp(minus 2 times r divided by a subscript 0) times (1 plus a subscript 0 divided by r).")]
        ...
        //[InlineData("α + β", "alpha plus beta")]
        //[InlineData("Δ - γ", "Delta minus gamma")]
        ...
        //[InlineData("√(a² + b²)", "the square root of (a squared plus b squared)")]
        ...
        //[InlineData("E ⊂ F and G ⊃ H", "E subset of F and G superset of H")]
        ...
        //[InlineData("K⁺", "K plus")]
        //[InlineData("The equation is α² + β² = γ².", "The equation is alpha squared plus beta squared equals gamma squared.")]
        //[InlineData("Is it true that ∀ x ∈ ℝ, x² ≥ 0?", "Is it true that for all x in the set of real numbers, x squared greater than or equal to 0?")]
        //[InlineData("The formula for water is H₂O.", "The formula for water is H subscript 2 O.")]
        //[InlineData("The limit is lim_{x→∞} (1/x) = 0.", "The limit is limit as x approaches infinity of (1 divided by x) equals 0.")]
        //[InlineData("This is a vector: F⃗.", "This is a vector: vector F.")]
        //[InlineData("The angle is 90°.", "The angle is 90 degrees.")]
        //[InlineData("The subset symbol is ⊂.", "The subset symbol is subset of.")]
        //[InlineData("This is the sum: ∑ᵢ₌₁ⁿ i.", "This is the sum: summation from i equals 1 to n i.")]
        //[InlineData("The result is approximately ≈ 5.", "The result is approximately equal to 5.")]
        //[InlineData("The equation x¹ + y¹ = z¹ is simple.", "The equation x to the power of 1 plus y to the power of 1 equals z to the power of 1 is simple.")]
        //[InlineData("This is a test with a mix of symbols: α, β, γ.", "This is a test with a mix of symbols: alpha, beta, gamma.")]
        //[InlineData("Let's test a fraction: 1/2.", "Let's test a fraction: 1 divided by 2.")]
        //[InlineData("The integral is ∫ₐᵇ f(x) dx.", "The integral is integral from a to b f(x) dx.")]
        //[InlineData("This is a test of the not symbol: ¬A.", "This is a test of the not symbol: not A.")]
        //[InlineData("The result is ∞.", "The result is infinity.")]
        //[InlineData("This is a test of the prime symbol: f′.", "This is a test of the prime symbol: f prime.")]
        //[InlineData("The equation is E = mc².", "The equation is E equals mc squared.")]
        //[InlineData("This is a test of the greater than or equal to symbol: ≥.", "This is a test of the greater than or equal to symbol: greater than or equal to.")]
        //[InlineData("This is a test of the less than or equal to symbol: ≤.", "This is a test of the less than or equal to symbol: less than or equal to.")]
        //[InlineData("The vector component is vᵧ.", "The vector component is v subscript gamma.")]
