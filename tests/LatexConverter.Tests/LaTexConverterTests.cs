...
public class LaTexConverterTests
{
    ...
    [InlineData(@"V(r) = (q / (4 * π * ε_0 * a_0)) * exp(-2 * r / a_0) * (1 + a_0 / r).", "V(r) = (q / (4 * pi * varepsilon_0 * a_0)) * exp(-2 * r / a_0) * (1 + a_0 / r).")]
    [InlineData(@"y_ob to a", "y_ob to a")]
    [InlineData("A small segment of the wire is marked in blue as \"dl\",", "A small segment of the wire is marked in blue as \"dl\",")]
    [InlineData("the quantity (x/2 squared plus l squared) raised to the power of 3/2.", "the quantity (x/2 squared plus l squared) raised to the power of 3/2.")]
    [InlineData("An x-y coordinate system is shown in the top right corner,", "An x-y coordinate system is shown in the top right corner,")]
    ...
    [InlineData(@"V(r) = (q / (4 * π * ε_0 * a_0)) * exp(-2 * r / a_0) * (1 + a_0 / r).", "V(r)=(q/(4*π*ε₀*a₀))*exp(-2*r/a₀)*(1+a₀/r).")]
    [InlineData(@"y_ob to a", "y_ob to a")]
    [InlineData("A small segment of the wire is marked in blue as \"dl\",", "A small segment of the wire is marked in blue as \"dl\",")]
    [InlineData("the quantity (x/2 squared plus l squared) raised to the power of 3/2.", "the quantity (x/2 squared plus l squared) raised to the power of 3/2.")]
    [InlineData("An x-y coordinate system is shown in the top right corner,", "An x-y coordinate system is shown in the top right corner,")]
    ...
    [InlineData(@"V(r) = (q / (4 * π * ε_0 * a_0)) * exp(-2 * r / a_0) * (1 + a_0 / r).", "V(r) equals (q divided by (4 times pi times varepsilon subscript 0 times a subscript 0)) times exp(minus 2 times r divided by a subscript 0) times (1 plus a subscript 0 divided by r).")]
    [InlineData(@"y_ob to a", "y subscript ob to a")]
    [InlineData("A small segment of the wire is marked in blue as \"dl\",", "A small segment of the wire is marked in blue as \"dl\",")]
    [InlineData("the quantity (x/2 squared plus l squared) raised to the power of 3/2.", "the quantity (x divided by 2 squared plus l squared) raised to the power of 3 divided by 2.")]
    [InlineData("An x-y coordinate system is shown in the top right corner,", "An x-y coordinate system is shown in the top right corner,")]
