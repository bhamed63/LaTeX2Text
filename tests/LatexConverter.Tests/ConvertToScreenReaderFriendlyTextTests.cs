...
namespace LatexConverter.Tests
{
    public class ConvertToScreenReaderFriendlyTextTests
    {
        ...
        [InlineData(@"\begin{pmatrix} a & b \\ c & d \end{pmatrix}", "a 2-by-2 matrix with row 1: a, b, and row 2: c, d")]
        // [InlineData(@"\begin{matrix} a & b \\ c & d \end{matrix}", "a 2x2 matrix with rows (a, b) and (c, d)")]
        [InlineData(@"\begin{matrix} a & b \\ c & d \end{matrix}", "a 2-by-2 matrix with row 1: a, b, and row 2: c, d")]
        // [InlineData(@"\begin{vmatrix} a & b \\ c & d \end{vmatrix}", "a 2x2 matrix with rows (a, b) and (c, d)")]
        [InlineData(@"\begin{vmatrix} a & b \\ c & d \end{vmatrix}", "a 2-by-2 matrix with row 1: a, b, and row 2: c, d")]
        // [InlineData(@"\begin{Vmatrix} a & b \\ c & d \end{Vmatrix}", "a 2x2 matrix with rows (a, b) and (c, d)")]
        [InlineData(@"\begin{Vmatrix} a & b \\ c & d \end{Vmatrix}", "a 2-by-2 matrix with row 1: a, b, and row 2: c, d")]
        // [InlineData(@"\begin{bmatrix} a & b \\ c & d \end{bmatrix}", "a 2x2 matrix with rows (a, b) and (c, d)")]
        [InlineData(@"\begin{bmatrix} a & b \\ c & d \end{bmatrix}", "a 2-by-2 matrix with row 1: a, b, and row 2: c, d")]
        ...
        [InlineData(@"The vector is \perp to the plane.", "The vector is perpendicular to the plane.")]
        ...
        [InlineData(@"The \Re part and the \Im part.", "The Real part and the Imaginary part.")]
